  ...
  <div class="container">
    <div class="hub-grid">
      <a class="hub-card" href="{{ '/dusk-studio/' | relative_url }}">
        ...
        <h3>Dusk Studio</h3>
        <p>A portastudio-style DAW. 24 tracks, MIDI and audio, a fixed signal chain, mastering built in. In beta: $1+/month on Patreon gets you prebuilt binaries, or build it free.</p>
